...
def main():
    ...
    if h != None:
        ...
        if args.name:
            merge_command = f'samtools merge -r -@ {n} -o - {file_combined} | samtools sort -@ {n} - -n -o {o}.bam'
        else:
            merge_command = f'samtools merge -r -@ {n} -o {o}.bam {file_combined} && samtools index -@ {n} {o}.bam'
